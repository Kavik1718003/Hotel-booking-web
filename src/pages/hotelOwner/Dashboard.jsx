  ...
  return (
    <div>
      ...
      <div className='flex gap-4 my-8 flex-wrap'>
        {/* ---Total Bookings--- */}
        <div className='bg-primary/30 border border-primary/10 rounded flex items-center p-4 pr-8'>
          <img src={assets.totalBookingIcon} alt="total bookings" className='max-sm:hidden h-10' />
          <div className='flex flex-col sm:ml-4 font-medium'>
            <p className='text-gray-700 text-lg'>Total Bookings</p>
        ...
        <div className='bg-primary/30 border border-primary/10 rounded flex items-center p-4 pr-8'>
          ...
          <div className='flex flex-col sm:ml-4 font-medium'>
            <p className='text-gray-700 text-lg'>Total Revenue</p>
            ...
            {dashboardData.bookings.map((item, index) => (
              <tr key={index} className='border-t border-gray-300'>
                ...
                <td className='py-3 px-4 text-center'>
                  <span className={`py-1 px-3 text-xs rounded-full inline-block ${item.isPaid ? 'bg-green-200 text-green-600' : 'bg-amber-200 text-yellow-600'}`}>
